...
| 2026-05-20 | submit-08 | DWT/artifact ensemble with fixed postprocess parameters `alpha=1.0`, `tau=30`, `w_pf=0.07` | Fine `tau` search above best submit-02 | Pending | Kaggle kernel `beicicc/rogii-dwt-fixed-tau30-wpf007-08` v1 accepted at 2026-05-20 07:50:13 UTC. |
