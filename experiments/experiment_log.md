...
| 2026-05-20 | submit-06 | DWT/artifact ensemble with fixed postprocess parameters `alpha=1.0`, `tau=25`, `w_pf=0.05` | Lower `w_pf` bracket around best submit-02 | Pending | Kaggle kernel `beicicc/rogii-dwt-fixed-tau25-wpf005-06` v1 accepted at 2026-05-20 05:04:13 UTC. |
